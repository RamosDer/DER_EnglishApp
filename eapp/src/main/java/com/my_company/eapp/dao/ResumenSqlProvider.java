...
public class ResumenSqlProvider {
    ...
    public String insertSelective(Resumen row) {
        ...
        if (row.getFechaDePractica() != null) {
            sql.VALUES("fecha_de_practica", "#{fechaDePractica,jdbcType=DATE}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (row.getTiempo() != null) {
            sql.SET("tiempo = #{row.tiempo,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Resumen row) {
        ...
        if (row.getTiempo() != null) {
            sql.SET("tiempo = #{tiempo,jdbcType=INTEGER}");
        }
        
        if (row.getFechaDePractica() != null) {
            sql.SET("fecha_de_practica = #{fechaDePractica,jdbcType=DATE}");
        }
